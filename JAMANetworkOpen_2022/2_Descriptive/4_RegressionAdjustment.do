...
* Key edits: 
   -  1/13/22: added negative binomial to trimmed sample
*******************************************************************************/
...
local skew = 2 // Type of transformation: 1=asinh^{-1}(y), 2=log(y+1), 3 = negative binomial
********************************************************************************
...
local myouts_personweighted tc p_tc_op p_tc_pcp p_tc_ed p_tc_ip oop p_oop_op p_oop_pcp p_oop_ed p_oop_ip 
